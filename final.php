...
<table border="1" cellpadding="4">
			...
			<?php 
						 ...
						 $results = $db->prepare('SELECT c.studentID, c.studentFN, c.studentLN, s.periodNum, p.programName FROM cadet c INNER JOIN schedule s ON c.studentID = s.studentID INNER JOIN program p ON s.programID = p.programID WHERE c.studentID = ? ORDER BY p.programID ASC;');
